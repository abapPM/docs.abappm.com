...
- general abuse reports that should be handled under the [Code of Conduct](/policies/code-of-conduct.html)
...
Send a report to [support@abappm.com](mailto:support@abappm.com) with as much detail as possible, including:
...
It is against the [Terms of Use](/policies/terms-of-use.html) to reserve names in bad faith for future use, resale, impersonation, or ecosystem disruption.
...
If you believe a package, user, or organization name infringes your trademark, contact [support@abappm.com](mailto:support@abappm.com?subject=Trademark) and include the evidence needed to evaluate the claim.

Use of apm branding is governed by [Logos and Usage](/policies/logos-and-usage.html).
...
- [Code of Conduct](/policies/code-of-conduct.html)
- [Unpublish Policy](/policies/unpublish-policy.html)
