...
Do not publish exploit details publicly before apm has had a reasonable opportunity to investigate and respond.

Alternatively, you may report suspected security vulnerabilities privately to [support@abappm.com](mailto:support@abappm.com?subject=Security).

## What to Include

Please include:

- affected service, package, or workflow
- steps to reproduce
- expected impact
...
apm will review reports in good faith and may:

- acknowledge receipt
- request more detail
- investigate and prioritize remediation
- coordinate mitigation, removal, or service restrictions if needed

## Safe Conduct

Please avoid actions that would:

- access data that is not yours
- disrupt service availability
- degrade the experience of other users
- create legal or safety risks while testing

## Related

- [Unpublish Policy](/policies/unpublish-policy.html)
- [Replication and Crawler Policy](/policies/replication-and-crawler-policy.html)
